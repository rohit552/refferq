    ...
    if (reportType === 'associations') {
      ...
      reportData = {
        ...
        data: referrals.map(referral => ({
          ...
          associationName: referral.affiliate.user.name,
          associationCode: referral.affiliate.referralCode,
      ...
      reportData = {
        ...
        data: incentives.map(incentive => ({
          ...
          associationName: incentive.affiliate.user.name,
          associationEmail: incentive.affiliate.user.email,
